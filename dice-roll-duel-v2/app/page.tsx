      ...
      <div className='max-w-4xl mx-auto text-center'>
        ...
        <div className='mb-12'>
          <p className='text-xl md:text-2xl text-gray-200 mb-6 max-w-2xl mx-auto leading-relaxed'>
            Challenge players in this thrilling 1v1 dice rolling competition.
            Roll higher than your opponent to win rounds and climb the
            leaderboard!
          </p>
        ...
        <div className='mt-16 text-gray-400 text-sm'>
          <p>Best of 3 · ELO Ranked · Fully Random 🎲</p>
        </div>
      </div>
    </main>
  );
